...
For choosing between alternatives, the Alternative type class will do, so we 
create an instance that is defined in terms of the Alternative instance of the
