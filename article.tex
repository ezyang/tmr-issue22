...
MonadState constraint in the type signature.  The mtl 
\EZY{which?} 
\Matt{I'm not sure what the library's called -- is it mtl or transformers?} 
\EZY{Well, both export the necessary interfaces. Just pick one and be consistent.} 
formulation of monad
