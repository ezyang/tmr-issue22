...
\EZY{The new sentence you added here is really awkward} We have shown that the insertion operation maintains all invariants in red-black trees by adding necessary properties to the tree data type and then modifying the functions accordingly. However, the previous code illustrates a general problem with proofs. In fact, in Haskell $\bot$ (bottom) is a member of every type. As a result, we can write:
...
\EZY{You should probably cite Data Types a la Carte here}
