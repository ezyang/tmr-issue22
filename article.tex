...
-- can be built out of the StateT monad transformer applied to Maybe.  \EZY{Do you maybe want to say why this is the case?}  We can 
...
MonadState constraint in the type signature.  This \EZY{which?} formulation of monad
...
our new parsers have three possible results:  success, failure, and error. \EZY{Question a reader might have: what is the difference between failure and error?  You give a little guidance later but give some intuition now!}  Note
